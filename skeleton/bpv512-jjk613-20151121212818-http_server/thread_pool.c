...
// Deletes the queue and all nodes still in the queue
// if working properly, no elements should be in the queue
// and all threads should have been joined by now.
void queueDelete(pool_task_t* queue)
{
    //deletes the queue
    if (queue==NULL)
